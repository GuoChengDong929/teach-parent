...
public class SuperviseService {
    ...
    public Result getWeekScoresByDate(Map<String, Object> map) throws ParseException {
        String classesId = map.get("classesId").toString();
    ...
    public Result getMonthScoresByDate(Map<String, Object> map) throws ParseException {
        String classesId = map.get("classesId").toString();
